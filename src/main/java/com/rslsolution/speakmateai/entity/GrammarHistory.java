...
public class GrammarHistory {
	...
	public static class GrammarHistoryBuilder {
		...
		public GrammarHistoryBuilder id(Long id) {
			this.id = id;
			return this;
		}

		public GrammarHistoryBuilder user(User user) {
			this.user = user;
			return this;
		}

		public GrammarHistoryBuilder originalText(String originalText) {
			this.originalText = originalText;
			return this;
		}

		public GrammarHistoryBuilder correctedText(String correctedText) {
			this.correctedText = correctedText;
			return this;
		}

		public GrammarHistoryBuilder explanation(String explanation) {
			this.explanation = explanation;
			return this;
		}

		public GrammarHistoryBuilder grammarScore(Double grammarScore) {
			this.grammarScore = grammarScore;
			return this;
		}

		public GrammarHistoryBuilder mistakesCount(Integer mistakesCount) {
			this.mistakesCount = mistakesCount;
			return this;
		}

		public GrammarHistoryBuilder createdAt(LocalDateTime createdAt) {
			this.createdAt = createdAt;
			return this;
		}
